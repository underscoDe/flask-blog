...
from flask import (
    render_template, flash, url_for, redirect, request, abort
)
from flaskblog import app, db, bcrypt
from flaskblog.forms import (
    LoginForm, RegistrationForm, UpdateAccountForm, PostForm
)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(
            ...
            flash(f'Login failed. Check your credentials.', 'danger')
...
def save_picture(form_picture):
    ...
    fname = random_hex + fext
    # pic_path = os.path.join(app.root_path, '/static/profile_pics', fname)
    pic_path = f'{app.root_path}/static/profile_pics/{fname}'
